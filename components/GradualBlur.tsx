...
const useIntersectionObserver = (ref: React.RefObject<any>, shouldObserve: boolean | 'scroll' = false) => {
...
interface GradualBlurProps extends Partial<Config> {
    preset?: string;
}
...
function GradualBlur(props: GradualBlurProps) {
    ...
    const isVisible = useIntersectionObserver(containerRef, config.animated);
